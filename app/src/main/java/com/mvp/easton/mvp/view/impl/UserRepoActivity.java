...
import com.mvp.easton.mvp.adapter.RepositoryAdapter;
import com.mvp.easton.mvp.model.Repository;
import com.mvp.easton.mvp.presenter.impl.UserRepoPresenterImpl;
...
public class UserRepoActivity extends AppCompatActivity implements UserRepoBaseView, View.OnClickListener {
    ...
    private void hideSoftKeyBoard() {
        ...
        inputMethodManager.hideSoftInputFromWindow(edit_text_username.getWindowToken(), 0);
    }
